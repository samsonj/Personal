...
//CLOSE LEFT
	jQuery(document).on('click', '#close-left', function () {
		jQuery('#wrap, .footer-container').css('-webkit-transform', 'translate3d(0px,0,0)');
		jQuery('#wrap, .footer-container').css('-moz-transform', 'translate3d(0px,0,0)');
		jQuery('#wrap, .footer-container').css('-ms-transform', 'translate3d(0px,0,0)');
		jQuery('#wrap, .footer-container').css('-o-transform', 'translate3d(0px,0,0)');
		jQuery('#wrap, .footer-container').css('transform', 'translate3d(0px,0,0)');

		//Position Mobile Navigation back to it initial start point.
		jQuery('#nav-left').css('-webkit-transform', 'translate3d(0px,0,0)');
		jQuery('#nav-left').css('-moz-transform', 'translate3d(0px,0,0)');
		jQuery('#nav-left').css('-ms-transform', 'translate3d(0px,0,0)');
		jQuery('#nav-left').css('-o-transform', 'translate3d(0px,0,0)');
		jQuery('#nav-left').css('transform', 'translate3d(0px,0,0)');
						
		jQuery('.sbSelector').css({'border-color': ''});
		jQuery('.sbSelector').css({'color': ''});
		jQuery('.sbToggle').css({'border-color': ''});
		jQuery('.sbToggle').css({'background-position': ''});
		jQuery('.sbOptions').css({'border-color': ''});
		jQuery("#btnopencart").addClass("disable");
...
//RIGHT
	...
	jQuery(function() {
		jQuery('#close-cart').bind('click',function(event){
			...
			//left section slide control (place underneth of current slide and move to it intial start point.)
			jQuery('#left-section').css('z-index', '1'); 
			jQuery('#left-section').css('-webkit-transform', 'translate3d(0px,0,0)');
			jQuery('#left-section').css('-moz-transform', 'translate3d(0px,0,0)');
			jQuery('#left-section').css('-ms-transform', 'translate3d(0px,0,0)');
			jQuery('#left-section').css('-o-transform', 'translate3d(0px,0,0)');
			jQuery('#left-section').css('transform', 'translate3d(0px,0,0)');
...
//BOTTOM
	// jQuery(document).on('click', '#open-bottom, .request-cv', function () {
	...
	jQuery(function() {
		jQuery('#open-bottom, .request-cv').on('click',function(event){
			jQuery('.footer-container').css('-webkit-transform', 'translate3d(0,0,0)');

			
			// jQuery('#wrap,  #overlay-bg').css('-webkit-transform', 'translate3d(0,-285px,0)');    
			// jQuery('#wrap,  #overlay-bg').css('-moz-transform', 'translate3d(0,-490px,0)');
			// jQuery('#wrap,  #overlay-bg').css('-ms-transform', 'translate3d(0,-490px,0)');
			// jQuery('#wrap,  #overlay-bg').css('-o-transform', 'translate3d(0,-490px,0)');
			...
			jQuery('.portfolio-menu + div > .footer-container').css("display", "block");

			jQuery('html, body').animate({
        		scrollTop: jQuery(".footer-container").offset().top
   			}, 2000);
...
//CLOSE BOTTOM
	jQuery(function() {
	  	jQuery('#close-Bottom').bind('click',function(event){
			jQuery('#wrap').css('-webkit-transform', 'translate3d(0px,0,0)');
			jQuery('#wrap').css('-moz-transform', 'translate3d(0px,0,0)');
			jQuery('#wrap').css('-ms-transform', 'translate3d(0px,0,0)');
			jQuery('#wrap').css('-o-transform', 'translate3d(0px,0,0)');
			jQuery('#wrap').css('transform', 'translate3d(0px,0,0)');
			  //jQuery('#wrap').css('-webkit-transform', 'none');
...
//CLOSE CONTACT US BOTTOM
	jQuery(function() {
	  	jQuery('.footer-close').bind('click',function(event){
			jQuery('html, body').animate({
        		scrollTop: jQuery(".wrapper").offset().top
   			}, 1000);	
   			jQuery('.portfolio-menu + div > .footer-container').css("display", "none");
...
//SVG PRELOADER ANIMATION CALL
jQuery(document).ready(function() { 
	replaceWithPaths(jQuery('svg'));
	 drawSVGPaths(jQuery('svg'), 1000, 5000, 50); 
    	jQuery('#status').css('background-position', 'left bottom');			
    	jQuery('#status').animate({opacity: 1}, 2000);
    		setTimeout(pause, 2000);
    		function pause() {				
    			jQuery('#status').css('-webkit-transform', 'translate3d(0px, -500px, 0)');
    			jQuery('#status').css('-moz-transform', 'translate3d(0px, -500px, 0)');
    			jQuery('#status').css('-ms-transform', 'translate3d(0px, -500px, 0)');
    			jQuery('#status').css('-o-transform', 'translate3d(0px, -500px, 0)');
    			jQuery('#status').css('transform', 'translate3d(0px, -500px, 0)');
    			jQuery('#preloader').delay(900).fadeOut('slow');  
    		};				
});

setTimeout( function(){
jQuery('.path').css('fill','#000000')
},1820);

//SVG PRELOADER ANIMATION FUNCTIONS
